Feature: User Sign Up
  ...
  Scenario: Successful Sign Up with valid details
    ...
    | fullname         | email           | phone_number | password | confirm_password | tax_number | company_name |
    | test user        | test@gmail.com  | 0337704139   | 12345678 | 12345678         | 1234567890 | Test Company |
  ...
  Scenario: Sign Up with password mismatch
    ...
    When I enter the following details:
    | fullname         | email           | phone_number | password | confirm_password | tax_number | company_name |
    | test user        | test@gmail.com  | 0337704139   | 12345678 | test1234         | 1234567890 | Test Company |
    And I agree to the terms and conditions
    # And I click the "Đăng ký" button
